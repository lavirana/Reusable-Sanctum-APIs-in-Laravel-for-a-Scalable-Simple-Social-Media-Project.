				...
				<div class="header-data">
								...
								<div class="notification-box msg" id="message">
									...
									<div class="nott-list">
										<div class="notfication-details">
						  				...
						  				<div class="notfication-details">
							  				<div class="noty-user-img">
							  					<img src="https://gambolthemes.net/workwise-new/images/resources/ny-img3.png" alt="">
							  				</div>
							  				<div class="notification-info">
							  					<h3><a href="messages.html" title="">Jassica William</a></h3>
						  				...
						  				<div class="view-all-nots">
						  					<a href="/" title="" style="background:linear-gradient(135deg, #43cea2, #185a9d)">View All Messsages</a>
						  				</div>
									</div><!--nott-list end-->
					...
					<div class="user-account" style="border-left: #185a9d; border-right: #185a9d">
						...
						<div class="user-account-settingss" id="users">
							...
							<h3 class="tc"><a href="javascript:void(0);" onclick="logout()" title="">Logout</a></h3>
